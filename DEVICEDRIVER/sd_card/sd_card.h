...
#define MSD0_CS				PBout(11)
#define MSD0_DETECT         PFin(14)
#define MSD0_POWER_ON
...
#define MSD1_card_enable()      	GPIOB->BRR = GPIO_Pin_12 //GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define MSD1_card_disable()     	GPIOB->BSRR = GPIO_Pin_12 //GPIO_SetBits(GPIOB,GPIO_Pin_12)
